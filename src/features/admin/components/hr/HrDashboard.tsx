          ...
          <form className={`${styles.jobForm} ${styles.aiJobForm}`} noValidate>
            <section className={styles.aiJobInputPanel}>
              <label className={styles.fullField}>
                ...
                <input className={getInputClassName(Boolean(jobFieldErrors.title))} value={jobForm.title} maxLength={50} onChange={(e) => updateJobFormField('title', e.target.value)} placeholder="e.g. Senior Product Designer" />
                ...
                <div className={styles.aiLocationControls}>
                  ...
                  <div>
                    <div className={styles.iconInput}>
                      ...
                      <input className={getInputClassName(Boolean(jobFieldErrors.location))} value={jobForm.location} maxLength={50} onChange={(e) => updateJobFormField('location', e.target.value)} placeholder="e.g. San Francisco, CA" />
                    </div>
              ...
              <label>
                ...
                <input className={getInputClassName(Boolean(jobFieldErrors.applicationDeadline))} type="text" value={jobForm.applicationDeadline ? jobForm.applicationDeadline.slice(0, 10) : ''} maxLength={50} onChange={(e) => updateJobFormField('applicationDeadline', e.target.value)} placeholder="mm/dd/yyyy" />
              ...
              <div className={styles.aiSalaryField}>
                ...
                <div className={styles.aiSalaryControls}>
                  <div className={styles.salaryInputSlot}>
                    <div className={`${styles.moneyInput} ${jobFieldErrors.salaryMin ? styles.moneyInputError : ''}`}><span>$</span><input aria-label="Minimum salary" type="text" inputMode="decimal" value={salaryInputValues.salaryMin} maxLength={50} onChange={(e) => updateSalaryField('salaryMin', e.target.value)} placeholder="0" /></div>
                    <JobFieldError message={jobFieldErrors.salaryMin} />
                  </div>
                  <div className={styles.salaryInputSlot}>
                    <div className={`${styles.moneyInput} ${jobFieldErrors.salaryMax ? styles.moneyInputError : ''}`}><span>$</span><input aria-label="Maximum salary" type="text" inputMode="decimal" value={salaryInputValues.salaryMax} maxLength={50} onChange={(e) => updateSalaryField('salaryMax', e.target.value)} placeholder="0" /></div>
              ...
              <div className={styles.jobFieldGrid}>
                ...
                <label className={styles.deadlineField}>
                  ...
                  <div className={styles.iconInput}>
                    ...
                    <input className={getInputClassName(Boolean(jobFieldErrors.applicationDeadline))} type="date" value={jobForm.applicationDeadline.slice(0, 10)} maxLength={50} onChange={(e) => updateJobFormField('applicationDeadline', e.target.value ? new Date(e.target.value).toISOString() : '')} />
                  </div>
                  <JobFieldError message={jobFieldErrors.applicationDeadline} />
                </label>
                <div className={styles.salaryRangeRow}>
                  ...
                  <div className={styles.salaryRangeControls}>
                    <div className={styles.salaryInputSlot}>
                      <div className={`${styles.moneyInput} ${jobFieldErrors.salaryMin ? styles.moneyInputError : ''}`}><span>$</span><input aria-label="Minimum salary" type="text" inputMode="decimal" value={salaryInputValues.salaryMin} maxLength={50} onChange={(e) => updateSalaryField('salaryMin', e.target.value)} /></div>
                      <JobFieldError message={jobFieldErrors.salaryMin} />
                    </div>
                    <small className={styles.salaryRangeDivider}>To</small>
                    <div className={styles.salaryInputSlot}>
                      <div className={`${styles.moneyInput} ${jobFieldErrors.salaryMax ? styles.moneyInputError : ''}`}><span>$</span><input aria-label="Maximum salary" type="text" inputMode="decimal" value={salaryInputValues.salaryMax} maxLength={50} onChange={(e) => updateSalaryField('salaryMax', e.target.value)} /></div>
                      <JobFieldError message={jobFieldErrors.salaryMax} />
                    </div>
                  </div>
                </div>
