...
export const validationErrorMessages = {
  ...
  domainRequired: 'Please enter the domain / identifier.',
  industryRequired: 'Please select an industry.',
  regionRequired: 'Please select a region.',
  adminFullNameRequired: 'Please enter the administrator full name.',
  adminEmailRequired: 'Please enter the administrator email.',
  invalidAdminEmail: 'Please enter a valid administrator email.',
