...
import { passwordRequirementLabels } from '@/utils/passwordRequirements'
import { authApi } from '@/services/api/authApi'
import { getPasswordStrength } from '@/utils/passwordStrength'
import { getAppErrorMessage, getErrorCode } from '@/utils/errorManager'
import { authErrorMessages } from '@/services/error/authErrorMessages'
import { FIELD_LENGTH_LIMITS, isPasswordLengthValid } from '@/services/api/axiosErrorHandler'
import { clearAuthStorage, clearRequirePasswordChange } from '@/services/api/authStorage'
...
export { ChangePasswordView as CandidateChangePasswordView }
