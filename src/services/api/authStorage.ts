export type StoredAuthRole = 'candidate' | 'tenantAdmin' | 'superAdmin' | 'hr' | 'interviewer'
...
export function getStoredAuthRole(): StoredAuthRole | null {
...
function isStoredAuthRole(value: string | null): value is StoredAuthRole {
  return Boolean(
    value === 'candidate' ||
      value === 'tenantAdmin' ||
      value === 'superAdmin' ||
